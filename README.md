...
15 | `{radioGroupLabel}` <br> `{label}` <br> *radio button, not checked* <br> `{radioGroupLabel}` <br> `{label}` <br> *radio button, not checked* <br> | `{legend}` *grouping* <br> `{radioGroupLabel}` *grouping* <br> `{label}` <br> *radio button, not checked* <br> `{label}` <br> *radio button, not checked* | `{legend}` <br> *group* <br> `{label}` <br> *selected, radio button, 1 of 2* <br> `{label}` <br> *selected, radio button, 3 of 2* | `{legend}` <br> `{label}` <br> *radio button, unchecked, 1 of 2* <br> `{label}` <br> *radio button, unchecked, 2 of 2* | `{radioGroupLabel}` <br> `{label}` <br> *radio button, non-selected, 1 of 2* <br> `{label}` <br> *radio button, non-selected, 2 of 2*
